...
pub fn regular_polygons() -> RegularPolygons {
    RegularPolygons {
        ...
        center_generator: context_uniform_random_xy()
            .into_context_provider(vec![], |points, point| points.push(point)),
    }
}
...
pub struct RegularPolygons {
    ...
    center_generator: ContextProvider<(), Point2, Vec<Point2>>,
...
impl RegularPolygons {
    ...
    pub fn center(mut self, center_generator: ContextProvider<(), Point2, Vec<Point2>>) -> Self {
