...
pub struct ContextCrystallizedGeneratorHeart<Gen, Input, Output, Context>
where
    Input: 'static,
    Output: Clone + 'static,
...
impl<Gen, Input, Output, Context> ContextCrystallizedGeneratorHeart<Gen, Input, Output, Context>
where
    Input: 'static,
    Output: Clone + 'static,
    Context: Sized + 'static,
...
impl<Gen, Input, Output, Context> GeneratorHeart<Input, Output, Context>
    for ContextCrystallizedGeneratorHeart<Gen, Input, Output, Context>
where
    Input: 'static,
    Output: Clone + 'static,
    Context: Sized + 'static,
...
impl<Gen, Input, Output> IntoContextGenerator<Input, Output>
    for ContextCrystallizedGeneratorHeart<Gen, Input, Output, ()>
where
    Input: 'static,
    Output: Clone + 'static,
