...
pub trait PointGeneratorExtension: Generator<Output = Point2> + 'static {
    ...
    fn x_jitter_generator(self, x_amount: impl IntoF32Generator) -> JitterPointGenerator;
    fn y_jitter_generator(self, y_amount: impl IntoF32Generator) -> JitterPointGenerator;
}
