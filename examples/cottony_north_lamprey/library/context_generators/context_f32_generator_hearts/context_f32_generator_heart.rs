...
pub trait ContextF32GeneratorHeartExtension<Input, Context>:
    ...
    Context: Sized + 'static,
{
    fn normalize_generator(
        ...
        input_min: f32,
        input_max: f32,
    ) -> ContextMapOutputGeneratorHeart<Self, Input, f32, f32, Context> {
...
impl<Gen, Input, Context> ContextF32GeneratorHeartExtension<Input, Context> for Gen
where
    Input: 'static,
    Context: Sized + 'static,
