...
impl<Input, Context> GeneratorHeart<Input, GridPoint2, Context> for GridPoint
where
    Input: 'static,
...
impl GridPoint {
    ...
    pub fn dimensions(mut self, x_resolution: usize, y_resolution: usize) -> Self {
        self.x_resolution = x_resolution;
        self.y_resolution = y_resolution;
        self
    }
...
impl<Input> IntoContextGenerator<Input, GridPoint2> for GridPoint
where
    Input: 'static,
{
